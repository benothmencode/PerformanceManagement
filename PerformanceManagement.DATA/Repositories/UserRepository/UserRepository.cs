...
namespace PerformanceManagement.DATA.Repositories
{
    public class UserRepository : IUserRepository
    {
        ...
        {
            return _context.Users.Include(u => u.UserBadges).Include(u => u.VoteRights).Include(u => u.SystemeUsers).Where(u => u.Id == userId).FirstOrDefault();
        }
        ...
        {
            return _context.Users.Include(u => u.UserBadges).Include(u => u.VoteRights).OrderBy(u => u.Created).ToList();
        }
